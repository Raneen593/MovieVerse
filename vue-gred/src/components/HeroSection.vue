...
<template>
    ...
    <section v-if=" movies_api.length > 3" class="hero-section">
        ...
        <div class="container hero-content  d-flex align-items-center justify-content-center">
                ...
                <div class=" hero-info">
                    ...
                    <div class="d-flex align-items-center gap-2 hero-details">
                        <p class="hero-rating"><i class="fa-solid fa-star"></i>{{ movies_api[2].vote_average }}</p>
                        <p class="hero-dot">•</p>
                    ...
                    <div class="d-flex align-items-center gap-4 hero-buttons">
                        ...
                        <button class="hero-favorites"
                        @click="$emit('add-favorite', movies_api[2])">Add to Favorits</button>
                    </div>
                </div>

                <div class="hero-image">
                    <img :src="'https://image.tmdb.org/t/p/w500' + movies_api[2].poster_path">
                </div>
